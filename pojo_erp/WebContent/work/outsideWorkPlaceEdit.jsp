	 ...
	 <div class="row">
		   ...
		   <div class="col-6">
		      ...
		      <div class="col-2">
		 	  ...
		 	  <div class="col-8">
		    	  <input class="form-control mr-2" name="DL_TEL" value="02-2254-4445" placeholder="전화번호를 입력해주세요." id="DL_TEL">
		      </div>
		   	</div>
		   	<!-- 위도|경도 -->	
		   	<div class="row" style="padding:5px">
		    ...
		    <div class="row" style="padding:5px">
		     <div class="col-2">
		 	 ...
		 	 <div class="col-8">
		    	<input class="form-control mr-2" id="DL_DETAILADDRESS" value="에이스빌딩 205호" placeholder="상세주소를 입력해주세요." name="DL_DETAILADDRESS" >
		     </div>
		    </div>
		    <!-- 지사 -->	
