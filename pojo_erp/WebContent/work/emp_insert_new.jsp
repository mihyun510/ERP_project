						...
						<div class="row">
							<div class="col-sm-6">
								<table class="table table-boardered">
									...
									<tr>
										<th>주민번호</th>
										<td><input id="emp_resnum" type="text" class="form-control" name="emp_resnum"  value="890804-1053312" placeholder="주민번호를 입력하세요."></td>
									</tr>
									<tr>
										<th>사진</th>
									...
									<tr>
										<th>핸드폰</th>
										<td><input id="emp_phone" type="tel" class="form-control" name="emp_phone"  value="010-5120-5568" placeholder="핸드폰 번호를 입력하세요."></td>
									</tr>
									<tr>
										<th>이메일</th>
										<td><input id="emp_email" type="email" class="form-control" name="emp_email"  value="kim@naver.com" placeholder="이메일을 입력하세요."></td>
									</tr>
									<tr>
										<th>부서명</th>
										<td>
											<select id="dept_no" name="dept_no" class="form-control"  value="개발부" >
									...
									<tr>
										<th>부서번호</th>
										<td><input id="dept_no" type="text" class="form-control" name="dept_no"  value="20" placeholder="부서번호를 입력하세요.">
										</td>
									</tr>
								</table>
							...
							<div class="col-sm-6">
								<table class="table table-boardered">
									<tr>
										<th>내선번호</th>
										<td><input id="emp_extend" type="tel" class="form-control" name="emp_extend"  value="02-464-4523" placeholder="내선번호를 입력하세요."></td>
									</tr>
									<tr>
										<th>직급</th>
										<td><input id="emp_position" type="text" class="form-control" name="emp_position"  value="개발사원" placeholder="직급을 입력하세요."></td>
									</tr>
									<tr>
										<th>연봉</th>
										<td><input id="emp_salary" type="text" class="form-control" name="emp_salary"  value="5000" placeholder="연봉을 입력하세요."></td>
									</tr>
									<tr>
										<th>성별</th>
										<td>
											<select id="emp_gender" name="emp_gender"  value="남자" class="form-control" >
									...
									<tr>
										<th>입사일자</th>
										<td><input id="emp_hiredate" type="date" class="form-control"  value="2020-07-15" name="emp_hiredate"  ></td>
									</tr>
									<tr>
										<th>퇴사일자</th>
									...
									<tr>
										<th>은행</th>
										<td><input id="emp_bank" type="text" class="form-control" name="emp_bank"  value="국민은행" placeholder="은행을 입력하세요." ></td>
									</tr>

									<tr>
										<th>계좌번호</th>
										<td><input id="emp_account" type="text" class="form-control" name="emp_account"  value="933502-00-117533" placeholder="계좌번호를 입력하세요."></td>
									</tr>
								</table>
							</div>
