...
<script type="text/javascript">
	...
	*/
	...
	function save(){
		...
		$("#f_updInfo").attr("action","workAddEmp");
		$("#f_updInfo").submit();
	}
						...
						<div class="row">
							<div class="col-sm-6">
								<table class="table table-boardered">
									...
									<tr>
										<th>주민번호</th>
										<td><input id="emp_resnum" type="text" class="form-control" name="emp_resnum" value="921007-1011221" placeholder="주민번호를 입력하세요."></td>
									</tr>
									<tr>
										<th>사진</th>
										<td><input id="emp_photo" type="file" class="form-control" name="emp_photo" value="na.jsp" placeholder="사진을 등록하세요."></td>
									</tr>
									<tr>
										<th>핸드폰</th>
										<td><input id="emp_phone" type="tel" class="form-control" name="emp_phone" value= "010-1251-2451" placeholder="핸드폰 번호를 입력하세요."></td>
									</tr>
									<tr>
										<th>이메일</th>
										<td><input id="emp_email" type="email" class="form-control" name="emp_email" value="sk@naver.com" placeholder="이메일을 입력하세요."></td>
									</tr>
									<tr>
										<th>부서명</th>
										<td>
									...
									<tr>
										<th>부서번호</th>
										<td><input id="dept_no" type="text" class="form-control" value="20" name="dept_no" placeholder="부서번호를 입력하세요.">
										</td>
									</tr>
								</table>
							...
							<div class="col-sm-6">
								<table class="table table-boardered">
									<tr>
										<th>내선번호</th>
										<td><input id="emp_extend" type="tel" class="form-control" name="emp_extend" value="210" placeholder="내선번호를 입력하세요."></td>
									</tr>
									<tr>
										<th>직급</th>
										<td><input id="emp_position" type="text" class="form-control" value="사원" name="emp_position" placeholder="직급을 입력하세요."></td>
									</tr>
									<tr>
										<th>연봉</th>
										<td><input id="emp_salary" type="text" class="form-control" value="2600" name="emp_salary" placeholder="연봉을 입력하세요."></td>
									</tr>
									<tr>
										<th>성별</th>
										<td>
									...
									<tr>
										<th>은행</th>
										<td><input id="emp_bank" type="text" class="form-control" value="국민은행" name="emp_bank" placeholder="은행을 입력하세요." ></td>
									</tr>

									<tr>
										<th>계좌번호</th>
										<td><input id="emp_account" type="text" class="form-control" value="15215-02-202058" name="emp_account" placeholder="계좌번호를 입력하세요."></td>
									</tr>
								</table>
							</div>
