...
<script type="text/javascript">
	function save(){
  		...
  		var bm_no = $("#bm_no").val();
		location.href="boardUPD?bm_content="+bm_content+"&bm_title="+bm_title+"&bm_no="+bm_no; 
  		
/*  		$("#form").attr("method","get");
		$("#form").attr("action","boardUPD");
		$("#form").submit(); */
 	} 
 	</script>
                     ...
                     <div class="container" role="main">
                        <h2></h2>
                           <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="bm_title" id="bm_title" value="<%=bm_title %>" placeholder="제목을 입력해 주세요"></input>
                           </div>
                           <div class="mb-3">
                              <label for="content">내용</label>
                              <input type="hidden" value="<%=bm_no %>" id="bm_no"/>
                              <textarea class="form-control" rows="15" name="bm_content" id="bm_content"  placeholder="내용을 입력해 주세요"><%=bm_content %></textarea>
                           </div>
                           <div class="mb-3">
