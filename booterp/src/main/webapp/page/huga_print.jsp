...
<table style="margin-left: auto; margin-right: auto;" border="2" width="650" 
  ...
  <!--   <span id="ap_reporter"></span> -->
    ...
    <td width="209">
    	<input class="wrap2" id="ap_dname" type="text" style=" height:50px; line-height: 75px; width:98%; border: 0;" disabled>
    </td>
    </tr>
  	<tr>
    ...
    <td colspan="3" height="100px;">
    	<input class="wrap2" id="ap_prosessingdate" type="text" style=" height:50px;line-height: 75px; width:98%; border: 0;" disabled>
    </td>
  	</tr>
  	<tr>
